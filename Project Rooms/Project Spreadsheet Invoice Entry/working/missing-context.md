...
| GTI Stone Design final worksheet | routed to Review | Packet may belong to `Cabinets` because of countertops, but sinks could overlap `Plumbing Fixtures`; entry is now in the workbook `Review` tab pending final placement. |
