...
| Lowes PRO BYH 5997 statement closing `2026-03-17` for Outrigger | partial insert; partial Review | No exact workbook matches found for refs `83160`, `91816`, or `76164`; inserted those clear Plumbing Fixtures rows. Routed refs `74298`, `94293`, `84314`, `94895`, and statement interest to `Review` because of vendor-tab uncertainty, Home/non-project status, mixed-tab credit, PO conflict with an existing unrelated `$6.99` row, and accounting direction needed for interest. |
