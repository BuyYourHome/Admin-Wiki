...
| Lowes PRO BYH 5997 statement closing `2026-03-17` for Outrigger | on hold pending revised Doc Scan consumables | Initial partial Plumbing Fixtures insertion and later Review-first reprocess were both superseded. The live workbook was reverted to the pre-Lowes rollback copy, leaving no Lowes statement lines in Outrigger. Await revised line-item Statement Mode consumables from Doc Scan so Invoice Entry can route by project first and avoid placing non-Outrigger lines in the Outrigger workbook. |
