...
The heartbeat `invoice-entry-to-projects-backup-heartbeat` checks this project room hourly as a backup monitor. Direct Doc Scan follow-up messages remain the primary trigger for invoice-entry work.
