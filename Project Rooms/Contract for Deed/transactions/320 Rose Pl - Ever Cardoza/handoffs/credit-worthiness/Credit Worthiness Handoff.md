...
- Run type: current CWE rerun with affidavit package handoff.
...
- Source refresh date/time: 2026-06-11 18:34 ET.
...
- Current evaluation summary: `C:\Codex\Wiki Files\Project Rooms\Credit Worthiness Evaluator\outputs\320 Rose Pl - Ever Cardoza\26-06-11 Current Evidence Evaluation Summary v24.md`
- Current full DOCX report: `C:\Codex\Wiki Files\Project Rooms\Credit Worthiness Evaluator\outputs\320 Rose Pl - Ever Cardoza\26-06-11 320 Rose Ever Amarildo Cardoza Bolanos - Creditworthiness Evaluation Report - Document Preparation Ready v24.docx`
...
- Teams report archive: `C:\Users\wesbr\Buy Your Home\Buy Your Home - Property\28-SYH-320 Rose Pl\Selling\Ever Cordoza\Contract Package\Clean Package\Credit Worthiness Archive`
...
| --- | --- | --- | --- |
| Ever Amarildo Cardoza Bolanos | Buyer 1 / primary tenant-buyer. | Spreadsheet names this person as Selling-Buyer1. Passport/source file supports the same legal-style name. | Use spreadsheet/passport name unless counsel or updated ID resolves otherwise. |
| Maria Geraldina Sarmiento | Buyer 2 / signing buyer per spreadsheet. | Spreadsheet names this person as Selling-Buyer2. Passport filename also uses Maria Geraldina. | Treat as signing buyer. Confirm final legal spelling before final execution. |

## Evaluation And Readiness Status
...
- CFD document-preparation stop issue: none identified from current evidence if CFD carries the listed deliverables and attorney/compliance review items into the closing checklist.
- Closing execution status: not ready for final execution until the required affidavits, funds proof, final legal-name spelling, and attorney/compliance review are complete.
...
| --- | --- | --- |
| $6,000 earnest money | Not separately verified in current source evidence. | Missing or closing-verification needed. |
...
- Final signed/notarized versions of the approval-support affidavits.
...
- Final legal-name spelling confirmation for the second buyer. Her signing role is not open because she is listed as Selling-Buyer2.
- Resolution of the source conflict between the $2,701 proposed payment in one affidavit draft and the $2,504.43 payment in the live spreadsheet.
...
- Credit-report debt load remains high under the source-file ratio review; document preparation relies on compensating factors and business judgment.
- Related-company rent history is a compensating factor, but it is not independent landlord verification.
- One affidavit draft uses a $2,701 payment while the live spreadsheet uses $2,504.43. CFD should use the spreadsheet value unless Wes or counsel updates the spreadsheet.
...
- Counsel should decide whether any adverse-action or conditional-notice language is needed if terms change or if final execution remains subject to unresolved deliverables.
- CFD should confirm authority for Sell Your Home, LLC signatures before final documents are issued.
