...
| Item | Status | Notes |
| --- | --- | --- |
| Codex Environment `Update Existing Machine` overlap | resolved by boundary | Sync Github owns daily Git-only freshness checks and clean fast-forward pulls. Codex Environment retains machine setup, remote deployment, broader app/environment updates, and installed-skill synchronization. |
