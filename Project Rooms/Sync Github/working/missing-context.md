...
| Is automation installed on OfficeAssist? | pending deployment | OfficeAssist is registered for Sync Github but still requires an authorized local or Codex Environment deployment and one verified safe run on that computer. |
