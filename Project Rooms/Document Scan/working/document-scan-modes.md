...
| Credit Card Statement Mode | The document is a credit card statement, including Lowe's Pro card statements when treated as a statement. | Office Admin yearly credit-card folder from the folder map. | Route unclear account/date matches to statement review. Generate credit card statement reports when requested or appropriate. |
