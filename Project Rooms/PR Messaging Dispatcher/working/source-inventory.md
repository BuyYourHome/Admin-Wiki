...
| `tools\pr-messaging\low-token\` | isolated development release 0.1.0 | Dispatcher-owned staged source, fixture tests, safe shadow harness and plan-only installer; no active manager or heartbeat replacement. |
