...
| Wes's direct `authorize one real synthetic worker canary`, 2026-09-07 | authoritative, exactly one real synthetic | Authorizes the narrowly pinned one-shot worker/CLI path and one fresh existing-Quickbooks recipient validation. No production, recurring installation, heartbeat resume or business action. |
