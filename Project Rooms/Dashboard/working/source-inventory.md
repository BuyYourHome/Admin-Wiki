...
| --- | --- | --- | --- |
| `Project Rooms\*\README.md` | Project Room definitions | authoritative | Names, purposes, statuses, and matching skills. |
| `Agents and Automations Registry.md` | Shared registry | authoritative | Agent-like status and automation context. |
