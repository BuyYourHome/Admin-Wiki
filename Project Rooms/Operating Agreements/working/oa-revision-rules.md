...
- For Investment Services operating-agreement work, use `working\Investment Services\Investment Services OA Rules.md` and `working\Investment Services\Investment Services OA Process Control.xlsx`. Build from the SYH/Simplified OA or approved Reassembled OA source with BYH-like process discipline, but do not use the Wyoming Investment Services OA as the drafting source unless Wes explicitly changes that rule.
