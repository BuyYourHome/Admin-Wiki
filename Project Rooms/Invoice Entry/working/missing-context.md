...
| 908 Pond surveying invoice placement | needs decision | Sullivan Surveying invoice `2395` for `$561.00` has no duplicate evidence in `26_Project Management - 908 Pond St 3.xlsm`, but surveying/property due diligence is not an approved Vendor Tabs Mode tab and no documented Pond expense area was approved for this invoice. Decide whether this belongs in an existing sheet such as `Legal`, a Carrying expense table/category, a Review tab, or a new approved worksheet/category before insertion. |
