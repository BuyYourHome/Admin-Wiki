...
| Tim Fleming 908 Pond hours invoice | missing vendor verification | Free-text source email reports 22 Pond hours for 2026-07-06 through 2026-07-17. Wes supplied rate as `$62.50/hour`, producing a draft amount of `$1,375.00`. Invoice number, final worksheet, and vendor-confirmed formal invoice are still missing. Held under Create Vendor Invoice Mode pending Wes review of the verification email and Tim Fleming's confirmation. |
