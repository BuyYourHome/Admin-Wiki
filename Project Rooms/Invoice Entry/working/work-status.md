...
- External delivery evidence recorded: yes; latest Josh final-style presentation draft verified `2026-08-12T10:54:01Z`
...
| 3 | Josh Kennedy LLC Time Card, 2026-08-01 through 2026-08-15 | Accepted time through August 11 is 77 hours 55 minutes: 70 hours 25 minutes Tensity, 4 hours BackOffice, and 3 hours 30 minutes Rosebrooks. The corrected semimonthly amount is `$2,708.33`, calculated from `$65,000.00 / 24`; the earlier `$2,500.00` draft is superseded. Final-style presentation draft sent once to Wes and verified. | Continue accumulating source-supported time through August 15 and watch for a correction to the August 11 received-date assumption. Do not finalize, file, post, approve, or treat the invoice as payable before the period closes and Wes approves it. |
...
| Josh Kennedy LLC August 1-15 Time Card invoice | `Accumulating - Period Open - Final-Style Draft Sent`; stable number `INV-JKLLC-20260815-001`; 77 hours 55 minutes accepted through August 11; corrected amount `$2,708.33` from `$65,000.00 / 24`; delivery verified | Continue source-supported accumulation and reconcile any correction to the August 11 received-date assumption in place. Period closes August 15; no finalization, filing, posting, approval, payment, or paid status before close and Wes approval. |
