...
- Josh's August 16-31 packet is open as `INV-JKLLC-20260831-001`. The correction-review draft through August 21 carries `42 hours 25 minutes`: Pond `21 hours 55 minutes` under a visibly flagged August 17 working interpretation, Rosebrooks `12 hours`, BackOffice `7 hours 45 minutes`, and Tensity `45 minutes`. The fixed `$2,708.33` amount is allocated as `$1,399.39`, `$766.21`, `$494.84`, and `$47.89`, respectively. Request `IE-EMAIL-20260826-JOSH-SEMIMONTHLY-DAILY-DRAFT-001` was sent exactly once to Josh with Wes and Jenny copied and verified in OfficeAssist Sent Items at `2026-08-26T12:01:59Z`. The period remains open and the draft is not final, approved, filed, posted, paid, or proof of payment.
...
| 3B | Josh Kennedy LLC Time Card, 2026-08-16 through 2026-08-31 | Period open. Draft through August 21: Pond `21h55m`, Rosebrooks `12h00m`, BackOffice `7h45m`, Tensity `0h45m`, total `42h25m`; fixed amount `$2,708.33`. August 17 3:45-5:10 PM is carried once as a visibly flagged Pond working interpretation. Draft sent and verified `2026-08-26T12:01:59Z`. | Await corrections or new time. Reconcile changes into the same interval and invoice number, then regenerate the daily draft. Do not finalize, file, post, pay, or mark paid while the period is open. |
...
| Josh Kennedy LLC August 16-31 Time Card invoice | `Period Open - Correction-Review Draft Through August 21 Sent And Verified`; stable number `INV-JKLLC-20260831-001`; draft total `42h25m`; August 17 3:45 PM-5:10 PM carried once as a flagged Pond working interpretation | Await corrections or new time. Update the same line/invoice and send the next meaningful daily draft. No finalization, filing, posting, payment, or paid status while the period remains open. |
