...
- Josh's August 16-31 packet is open as `INV-JKLLC-20260831-001`. The prepared draft through August 25 carries `50 hours 55 minutes`: Pond `21h55m`, Rosebrooks `14h45m`, BackOffice `7h45m`, Tensity `0h45m`, and `5h45m` unallocated between Rosebrooks and BackOffice. The fixed `$2,708.33` draft amount reconciles as `$1,165.77`, `$784.58`, `$412.23`, `$39.89`, and `$305.86`, respectively. The earlier through-August-21 draft was sent and verified; the August 25 dispatch prohibited vendor contact, so the updated one-page PDF was prepared and verified but not emailed. The period remains open and the draft is not final, approved, filed, posted, paid, or proof of payment.
...
- Tim's August 24 and August 26 Pond sources are recorded once each in open draft accumulation `IE-TF-20260824-POND-001`: `7.0` hours at `$62.50`, total `$437.50`. They do not alter the approved August 17-20 invoice. The handoffs withheld vendor contact and live workbook action, so no PDF, email, filing, posting, approval, payment, or paid status occurred.
...
| 3B | Josh Kennedy LLC Time Card, 2026-08-16 through 2026-08-31 | Period open. Prepared draft through August 25: Pond `21h55m`, Rosebrooks `14h45m`, BackOffice `7h45m`, Tensity `0h45m`, unallocated `5h45m`, total `50h55m`; fixed amount `$2,708.33`. August 25 10:30 AM-4:15 PM is retained once as unallocated between Rosebrooks and BackOffice. Updated PDF prepared, not emailed under the dispatch no-contact restriction. | Clarify the August 25 allocation or separately authorize correction-review delivery. Reconcile into the same line/invoice. Do not finalize, file, post, pay, or mark paid while the period is open. |
...
| 3F | Tim Fleming Pond hours, 2026-08-24 through 2026-08-26 | Open Draft Facts Recorded. Draft invoice `IE-TF-20260824-POND-001`; `7.0` hours / `$437.50`. | Accumulate future supported Tim Pond time in this packet. Generate and route a correction-review draft only when vendor contact is authorized; do not file, post, approve, pay, or mark paid. |
...
| Josh Kennedy LLC August 16-31 Time Card invoice | `Period Open - Updated Draft Through August 25 Prepared - Allocation Needs Wes`; stable number `INV-JKLLC-20260831-001`; draft total `50h55m`; August 25 10:30 AM-4:15 PM retained once as unallocated between Rosebrooks and BackOffice | Clarify the August 25 allocation or authorize correction-review delivery despite the intake no-contact restriction. Update the same line/invoice. No finalization, filing, posting, payment, or paid status while the period remains open. |
...
| Tim Fleming Pond draft `IE-TF-20260824-POND-001` | `Open Draft Facts Recorded`; August 24 and 26 total `7.0` hours / `$437.50`; no PDF or external action | Continue duplicate-safe accumulation. Vendor contact was expressly withheld for these intakes; generate and route the correction-review draft only after authorized delivery or the applicable workflow trigger. |
