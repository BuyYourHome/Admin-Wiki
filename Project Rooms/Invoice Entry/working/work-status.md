...
- Status: `Active - Josh August 1-15 Awaiting Wes Approval; August 17 Allocation Needs Review; Lowe's 74830 Needs Wes`
...
- Josh's August 16-31 packet is open as `INV-JKLLC-20260831-001`. August 17 Pond time from 8:00 AM-3:45 PM is accepted once as `7 hours 45 minutes`. The separate 3:45 PM-5:10 PM interval (`1 hour 25 minutes`) is held unallocated because the source mentions both Pond/Tim framing and Rosebrooks wallpaper/estate-sale work without tying the interval to one project. No draft was generated or delivered.
...
| 3B | Josh Kennedy LLC Time Card, 2026-08-16 through 2026-08-31 | Period open. August 17 Pond 8:00 AM-3:45 PM is accepted once as 7 hours 45 minutes. The 3:45 PM-5:10 PM interval is held once as unallocated between Pond and Rosebrooks. No draft exists. | Clarify whether 3:45 PM-5:10 PM belongs to Pond, Rosebrooks, or a supported split. Then update the same held line and generate the correction-review draft. Do not guess. |
...
| Josh Kennedy LLC August 16-31 Time Card invoice | `Period Open - Partial August 17 Intake - Allocation Clarification Required`; stable number `INV-JKLLC-20260831-001`; accepted 7 hours 45 minutes Pond; held 1 hour 25 minutes unallocated | Clarify the 3:45 PM-5:10 PM project allocation between Pond and Rosebrooks or provide a supported split. No draft should be generated until resolved. |
