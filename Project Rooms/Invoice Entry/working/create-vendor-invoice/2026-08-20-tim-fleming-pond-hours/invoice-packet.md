...
- State: `Correction Review Draft Sent And Verified - Awaiting Corrections By Exception`
...
- Draft total: `$1,156.25`
- Approval, filing, workbook posting, payment, and paid status: not performed
