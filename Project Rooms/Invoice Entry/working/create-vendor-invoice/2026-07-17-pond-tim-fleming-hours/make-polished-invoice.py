...
APPROVED_PDF_PATH = BASE / "tim-fleming-pond-hours-invoice-approved.pdf"
INVOICE_NUMBER = "IE-TF-20260717-POND-001"
...
def build_invoice(
    ...
    payment_status_line="Not approved for payment",
    verification_note=(
    ...
    header = Table(
        [
            [
                ...
                Paragraph(
                    f"<b>{status_heading}</b><br/>{status_subheading}<br/>{payment_status_line}",
                    ParagraphStyle(
                        "HeaderRight",
                        parent=styles["Normal"],
                        alignment=2,
    ...
    status = Table(
        [
            [
                ...
                Paragraph(
                    f"<b>Invoice Date:</b> July 17, 2026<br/><b>Invoice #:</b> {INVOICE_NUMBER}",
                    styles["Body"],
                ),
            ]
        ],
    ...
    source = Paragraph(
        ...
        f"'FW: Pond hours week of 7/6-7/17'. Invoice number generated by Invoice Entry: {INVOICE_NUMBER}.",
        styles["Muted"],
    )
    story.append(source)
...
if __name__ == "__main__":
    ...
    build_invoice(
        ...
        title="Tim Fleming Pond Hours Invoice - Approved",
        status_heading="APPROVED INVOICE",
        status_subheading="Approved by Wes",
        status_line="Approved by Wes on July 22, 2026",
        payment_status_line="Invoice Entry does not process payment",
        verification_note=(
            "Tim Fleming confirmed this invoice by email reply on July 17, 2026 and again on July 22, 2026. "
            "Wes approved the invoice on July 22, 2026. Invoice Entry records the approval, filing, and spreadsheet status; "
            "payment handling remains outside Invoice Entry."
        ),
    )
    print(PDF_PATH)
    print(CONFIRMED_PDF_PATH)
    print(APPROVED_PDF_PATH)
