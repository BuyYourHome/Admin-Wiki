...
- Source email: `Project Rooms/SOPs/sources/emails/RE_ Task Instructions Item 021_ VCAP to Foreclosure List.msg`
- Extracted note: `Project Rooms/SOPs/sources/extracted-emails/Item 021 - VCAP to ForeclosureList.md`
- Spreadsheet item: 21
