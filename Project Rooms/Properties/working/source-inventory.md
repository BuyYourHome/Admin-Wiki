...
| 5512 Desert Willow Ln test instruction | Current Codex thread | authoritative | Wes asked to test the Properties workflow by creating a new project for `5512 Desert Willow Ln` and confirmed using Tensity as the template for now. |
...
| 5512 Desert Willow Ln test workbook | `Project Rooms\Properties\outputs\5512 Desert Willow Ln\Project Management - 5512 Desert Willow Ln.xlsm` | review output | Created from the Tensity working template and conservatively cleaned on the `Profit` sheet. |
