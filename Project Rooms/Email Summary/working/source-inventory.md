...
|---|---|---|---|
| Email Summary skill | `C:\Codex\Wiki Files\skills\email-summary\SKILL.md` | authoritative | Primary workflow definition for mailbox scan, cutoff, prioritization, summary body, and state update. |
