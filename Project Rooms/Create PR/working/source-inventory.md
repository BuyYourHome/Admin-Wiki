...
| Wes instruction for Project Room Relationship Diagram Mode | User instruction | authoritative | Defines Create PR mode for producing a grouped one-page SVG relationship diagram of Project Rooms, skills, automations, and major handoffs. |
