# 320 Rose Ever Cordoza - Preliminary File Review
...
- `sources/320 Rose Ever Cordoza/320 Rose Pl Purchase Summary.txt`
- `sources/320 Rose Ever Cordoza/320 Rose Pl Purchase Transcript.txt`
...
## Supported Transaction Snapshot

The June 4, 2026 meeting materials support the following working transaction snapshot:

- Property: 320 Rose Pl / Rose Place.
- Proposed buyer: Zillow materials show Ever Amarildo Cardoza; meeting materials use Ever / Eber / Ebert, so contract spelling still needs confirmation.
- Maria is referenced as part of the buyer household.
- Rose Place is vacant and could be occupied quickly if financing and paperwork are completed.
- Buyer currently occupies Tensity, with a stated lease expiration at the end of June 2026.
- Seller financing is being considered for Rose Place.
- Down payment requested: $20,790, stated as 6% of purchase price.
- Implied purchase price: $346,500.
...
- Identity is marked verified in the applicant details.
...
- Estimated monthly debt payments: **$2,162**.
- Total debt: **$86,790**.
- Open auto-loan balances of $16,536, $19,112, $22,864, and $28,278.
- Capital One credit-card balance of $0.

### Payment Ratios

Using the unverified $9,500/month stated income:

- Proposed housing payment: $2,701 / $9,500 = **28.4% housing ratio**.
- Proposed housing payment plus estimated credit-report debt payments: ($2,701 + $2,162) / $9,500 = **51.2% back-end ratio**.

The 28.4% housing ratio looks plausible by itself, but the 51.2% back-end ratio is high for a conservative ability-to-repay file, especially because the income is self-employed and unverified.

Using bank-statement deposits instead of the self-reported income, the proposed payment is not supportable from the documents currently in the folder.

### Cash To Close And Reserves

The file does not prove the buyer has:

- $6,000 earnest money due at contract signing.
- $20,790 total down payment.
- Closing funds.
...
- The buyer's legal name is inconsistent across the meeting materials.
- The transaction structure needs to be clarified because the meeting described both a note/mortgage style structure and a deed-transfer-after-payoff structure.
- The timeline is compressed because the Tensity lease is stated to end at the end of June 2026.
- The $2,701 monthly payment must be broken into principal, interest, tax escrow, and insurance escrow before affordability can be tested.
