...
- Whenever the manuscript or another review-ready file under `outputs\` is created or materially changed, prepare a delivery package to `WesWill@BuyYourHomeLLC.com` from `OfficeAssist@BuyYourHomeLLC.com` and send a direct handoff to the existing Email Monitor status task `01a03956-fe55-7f62-9c0a-17c18f763320` requesting Email Delivery mode.
