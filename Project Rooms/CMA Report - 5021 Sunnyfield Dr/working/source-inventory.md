...
|---|---|---:|---|---|
| Owner-provided request | Owner-provided fact | background | Subject is a manufactured home at 5021 Sunnyfield Dr, Raleigh, NC 27610 | Subject type and report request |
...
| Subject details/photos | Owner/property-file source | missing | Year, size, bed/bath, condition, land/title status, park/lot rent | Required before final CMA |

## Status Notes

No source in this room yet confirms the subject's size, year, condition, or whether the sale would include land. That missing fact materially changes value and financing.
