...
| --- | --- | --- |
| Which computers are initially in scope? | answered | WesStudio and Wes-VideoEditor are the currently registered active computers. Future approved computers should be evaluated for enrollment. |
