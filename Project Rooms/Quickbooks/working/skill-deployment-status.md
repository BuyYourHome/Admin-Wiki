...
| `QB-004` rename to Quickbooks with `Invoice` mode | `69050252`; readiness correction pending publication | `69050252` published; correction pending | `WES-VIDEOEDITOR` | Parent validation found installed tree `B5763F8321295410C5AB305F388E89FEF60E607BE875AE19FA22B861DE73810F` behind canonical tree `80959213F8329E056D2DDCF736B7F6914D0292ACAC5F16B44BF2B7852353619A`; resynchronization pending | Parent `prmsg-quickbooks-renamed-identity-validation-20260902-001` blocked; linked correction `prmsg-quickbooks-renamed-identity-validation-20260902-correction-001` pending | Blocked pending synchronized one-notification correction |
...
- Linked correction: `prmsg-quickbooks-renamed-identity-validation-20260902-correction-001`, pending publication, installed-tree synchronization, and a fresh exactly-one-notification lifecycle.
