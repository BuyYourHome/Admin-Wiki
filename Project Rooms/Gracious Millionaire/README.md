...
- Project branch: `project/gracious-millionaire`.
...
- For new substantive book/source material, use Interview mode first and then Rewrite mode. Interview mode should first turn the new material into Jean-guided conversation or interview scenes with source boundaries. Rewrite mode should then integrate that interview-informed material into the whole manuscript so chapter context, themes, redundancy, and sequencing are reconsidered across the book.
