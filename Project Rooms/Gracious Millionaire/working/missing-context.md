...
- Confirm whether the retrievable Outlook messages are the full intended source set.
- Decide whether *Gracious Millionaire* should preserve the raw first-person devotional memoir style or be edited into a more polished manuscript voice.
- Decide whether quoted poems, books, YouTube references, and scripture quotations should remain in the manuscript, be paraphrased, or move to notes/appendix.
