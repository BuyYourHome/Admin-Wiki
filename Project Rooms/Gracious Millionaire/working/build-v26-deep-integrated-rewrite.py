...
nav {{ position: sticky; top: 12px; align-self: start; background: #ffffff; border: 1px solid #d9ded5; padding: 16px; max-height: calc(100vh - 24px); overflow-y: auto; box-sizing: border-box; scrollbar-gutter: stable; }}
...
@media (max-width: 860px) {{
  ...
  nav {{ position: static; margin-bottom: 22px; max-height: none; overflow: visible; }}
