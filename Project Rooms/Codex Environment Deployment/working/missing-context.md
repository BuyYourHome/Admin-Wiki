...
| Which WesStudio applications must be installed on every target? | nearly resolved for Step 2 | Wes approved the Core, Business, and Optional Groups on 2026-07-21. Approval-gated remote/system items remain pending. See `working/application-classification.md`. |
