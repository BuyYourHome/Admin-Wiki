...
| Which WesStudio applications must be installed on every target? | needed for Step 2 | Classify the baseline as required, optional, bundled with Codex/Windows, or separately approval-gated before installation. |
