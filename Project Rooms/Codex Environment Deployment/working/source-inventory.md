...
| `working/application-classification.md` | Wes approval record | authoritative, in progress | Records the approved Step 2 Core Group and pending business, optional, and approval-gated groups. |
