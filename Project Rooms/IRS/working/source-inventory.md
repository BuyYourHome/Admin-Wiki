...
| Property records | External Teams source | source identified; review pending | Wes confirmed that all property records are in Teams, in the `All Properties` channel. Use this channel as the starting source for property documentation before requesting records again. Individual property folders, owning entities, document contents, and tax-year completeness remain to be verified. Keep sensitive records outside Git and record only minimal source references. |
