...
| Create PR | `create-pr` | `019fdc5e-a1da-7e10-b388-a3be3830ac89` | Route PR creation, standardization, and relationship-diagram mode here. | New PRs should be dispatcher-ready. |
...
| Facebook Engagement | `facebook-engagement` | pending | Route authorized photo review and Facebook Page post-draft work here after task registration. | Task creation blocked on 2026-08-08 because `create_thread` had no registered handler; no Google Photos access or external Facebook action is authorized. |
