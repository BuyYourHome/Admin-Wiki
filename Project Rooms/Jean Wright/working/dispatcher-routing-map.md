...
| Quickbooks Invoice | `quickbooks-invoice` | `01a05809-d732-7b80-80b9-63602b8a6032` | Route only validated, authorized QuickBooks invoice-creation handoffs from Invoice Entry after messaging and interim browser gates pass. | Authenticated Chrome readiness validated on WESSTUDIO without production impact. Each invoice requires exact-company confirmation, duplicate search, one save, and read-back; ambiguous results block retry. |
