...
| --- | --- | --- | --- | --- |
| LED lighting | `led-lighting` | `01a0b696-05a2-7291-a857-084a6f2bc2eb` | Pending messaging registration - not dispatchable. | WESSTUDIO; dedicated task created; worker enrollment and synthetic readiness required. 24-volt remodel lighting, controls, supplies and compatibility/load planning; no purchase or installation authority. |
...
| Doc Scan | `doc-scan` | `01a07d59-9052-7623-a03c-f2b80b9116e0` | Route scanned-document process design, active scan-processing questions, and scanned-statement intake here before Invoice Entry. | Replacement Doc Scan task on OFFICEASSIST authorized by Wes 2026-09-07; Invoice Entry handoffs route onward only after Doc Scan prepares structured packets. |
...
| Entity Relationship | `entity-relationship` | `01a09295-d979-7e00-ab98-9390d005a1bf` | Route entity relationship diagrams and entity-mapping work here after messaging readiness passes. | Dedicated WESSTUDIO task; pending messaging registration and not dispatchable. |
...
| Invoice Entry | `invoice-entry` | `01a03956-fa4f-77c1-9ab7-f709e5f1174e` | Route structured Invoice Entry work to this ready, dispatchable `OFFICEASSIST` task. | Messaging lifecycle completed 2026-09-10 with one notification, one attempt, and no manual intervention. Keep source documents outside Git; require the same dispatch ID in the durable accepted receipt. |
...
| IRS | `irs` | pending | Route entity-wide tax readiness, filing inventories, source completeness, CPA package, extension, notice, and filing-status work here. | Pending dedicated task and messaging registration; not dispatchable. |
