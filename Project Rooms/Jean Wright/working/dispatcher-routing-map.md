...
| Quickbooks Invoice | `quickbooks-invoice` | pending | Route only validated, authorized QuickBooks invoice-creation handoffs from Invoice Entry after all connector and messaging gates pass. | Pending connector and messaging readiness - not dispatchable; do not substitute browser automation or another task. |
