...
| Invoice Entry | `invoice-entry` | `01a03956-fa4f-77c1-9ab7-f709e5f1174e` | OFFICEASSIST. Pending messaging registration - not dispatchable; hold production until canonical readiness passes. | Keep source documents outside Git; require the same dispatch ID in the durable accepted receipt. |
