...
| Quickbooks Invoice | `quickbooks-invoice` | `01a05809-d732-7b80-80b9-63602b8a6032` | Route only validated, authorized QuickBooks invoice-creation handoffs from Invoice Entry after all connector and messaging gates pass. | Exact task and messaging lifecycle validated on WESSTUDIO; connector readiness pending - not dispatchable. Do not substitute browser automation or another task. |
