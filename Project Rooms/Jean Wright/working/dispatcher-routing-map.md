...
| PR Messaging Dispatcher | `pr-messaging-dispatcher` | pending on WES-VIDEOEDITOR | Infrastructure only; do not route business work here. | Wakes exact local destination tasks from machine-addressed central records. WES-VIDEOEDITOR task and heartbeat are pending. |
