...
| Create PR | `create-pr` | `019fdc5e-a1da-7e10-b388-a3be3830ac89` | Route PR creation, standardization, and relationship-diagram mode here. | Verified replacement task; new PRs should be dispatcher-ready. |
