...
- When Wes requests a draft/final-processing handoff or otherwise authorizes Invoice Entry processing, follow `working\time-card-invoice-entry-handoff-contract.md` and send the versioned packet to the registered Invoice Entry task `01a03956-fa4f-77c1-9ab7-f709e5f1174e`.
...
- Send a direct handoff to the existing Email Monitor status task `01a03956-fe55-7f62-9c0a-17c18f763320`, explicitly requesting Email Delivery mode.
