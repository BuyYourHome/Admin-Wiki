$work = 'C:\Codex\Wiki Files\Project Rooms\Project Management Spreadsheet Redesign\working\amortization-mode\24_Project Management - 4121 Tensity Dr 2 - teams fetched 20260622-1623.xlsm'
