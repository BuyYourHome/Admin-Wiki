...
description: Draft workflow for turning Buy Your Home project-management workbooks into clean reusable templates and converting active project spreadsheets into that template. Use inside the Pinetree project room while proving the process; do not install as a Codex skill until validated.
---
