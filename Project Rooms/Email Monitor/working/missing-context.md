...
- 2026-06-15: Live automation was converted from standalone cron to heartbeat attached to the dedicated `Email Summary` thread so daily runs stop creating new chats.
