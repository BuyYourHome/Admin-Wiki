...
|---|---|---|
| Should the new development chat also become the live automation `target_thread_id`? | This controls where future failure/blocker notices appear. Changing it affects live automation visibility. | Resolved: the preserved WesStudio Email Monitor task `019ecba7-f1cc-7ac1-aaf7-d89a3f21b582` was restored during the 2026-08-24 rollback review. OfficeAssist task `01a029bf-81d2-76e1-9960-64558a57640b` remains inactive. |
