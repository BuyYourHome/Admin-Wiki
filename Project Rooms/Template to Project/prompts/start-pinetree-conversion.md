...
- Pinetree source workbook:
  `C:\Codex\Wiki Files\Project Rooms\Template to Project\sources\17_Project Management - 3413 Pinetree Ln - source.xlsx`
- Pond St template workbook:
  `C:\Codex\Wiki Files\Project Rooms\Template to Project\template-reference\26_Project Management - 908 Pond St 3 - template.xlsm`
- Pleasant Garden Carrying reference:
  `C:\Codex\Wiki Files\Project Rooms\Template to Project\template-reference\19_Project Management - 1426 Pleasant Garden Ln - Carrying reference.xlsx`
...
4. Make timestamped backups in:
   `C:\Codex\Wiki Files\Project Rooms\Template to Project\working\backups`
5. Build the converted workbook only in:
   `C:\Codex\Wiki Files\Project Rooms\Template to Project\Need Verification`
