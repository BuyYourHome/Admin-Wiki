# Git Cleanup Review - Template to Project Working Artifacts
...
- `Project Rooms/Template to Project/working/format-standardization-test/`
- `Project Rooms/Template to Project/working/worksheet-migration/`
