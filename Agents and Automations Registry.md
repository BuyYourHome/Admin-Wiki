...
- Current queued test and remaining WES-VIDEOEDITOR pull step: [[Project Rooms/Create PR/outputs/WES-VIDEOEDITOR Dispatcher Validation Queue 2026-09-05]]. The normal next window begins Monday, 2026-09-07, at 7:30 AM Eastern. Wes's linked decision `prmsg-jean-wve-synthetic-hours-exception-20260905-001` permits only this test today for at most one hour, conditional on safe local setup and automatic restoration. No override is installed or verified from WESSTUDIO; see [[Project Rooms/Create PR/outputs/WES-VIDEOEDITOR One-Hour Synthetic Exception Setup]].
