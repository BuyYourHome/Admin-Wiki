...
- Defined mode: Daily Email Summary scans Boss's and Jenny's Outlook mailboxes once daily, drafts priority summaries with usage totals, hands delivery to `email-delivery`, verifies OfficeAssist Sent Items, and updates summary state.
