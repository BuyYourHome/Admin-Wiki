...
| Network Roadmap | Wiki-managed skill plus project room plus dedicated task | Pending setup | On demand | `skills\network-roadmap\SKILL.md`; `Project Rooms\Network Roadmap\README.md`; task id `pending` |
