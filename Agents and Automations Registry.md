...
| Bathroom Fixtures | Wiki-managed skill plus project room; dedicated task pending | Pending setup | On demand | `skills\bathroom-fixtures\SKILL.md`; `Project Rooms\Bathroom Fixtures\README.md`; task id pending |
