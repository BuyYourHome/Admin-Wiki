...
### Total Co-Living Suites (4 Units)
...
The current planning configuration assumes each floor contains the same suite mix:

| Floor | Premium Suites | Co-Living Suites | Total Suites |
|---|---:|---:|---:|
| First floor | 2 | 2 | 4 |
| Second floor | 2 | 2 | 4 |
| **Total** | **4** | **4** | **8** |

Future floor plan exhibits should preserve scale against the 6,000 SF building assumption. Any prior concept plan should be treated as conceptual only if it does not reflect this scale and floor-by-floor suite mix.
...
| 3 | High | 12,000 | 144,000 |

The Annual Model uses the rent case with the latest effective year that is less than or equal to the model year. Under the current schedule, Year 1 uses low rent, Year 2 uses medium rent, and Year 3 forward uses high rent.

The stabilized monthly gross rent assumption now follows the same Rent Scenario Schedule based on the selected stabilization/refinance year. With the current refinance year selection of **Year 3**, the selected stabilized monthly gross rent is **12,000** for refinance valuation.
...
One possible marketing scenario is to rent one full floor as a short-term rental while keeping the other floor available for co-living or medium-term furnished rental demand. This should be treated as an operating/marketing option, not the base underwriting case, until zoning, insurance, tax, management, and occupancy constraints are confirmed.
