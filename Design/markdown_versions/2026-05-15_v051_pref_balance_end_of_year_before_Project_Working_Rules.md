...
* Waterfall preferred-return balance should carry forward directly:
  * `A Pref Balance` should equal prior-year `A Pref Balance` plus prior-year `Pref Accrued` less prior-year `Pref Paid`.
