...
* After capital return priorities are satisfied, residual distributions should be shared proportionally among Class A, Class B, and Sponsor based on Class A capital, Class B capital, and Sponsor basis.
* Current residual shares are calculated by formula:
  * Class A: Class A capital / total residual-sharing base,
  * Class B: Class B capital / total residual-sharing base,
  * Sponsor: Sponsor basis / total residual-sharing base.

## Annual Model Cash Roll-Forward

* The Annual Model should not treat annual cash as isolated.
* It should show current-year cash before refinance/sale, net refinance/sale proceeds, cash available before distributions, waterfall distributions, ending cash balance, total cash available, loan balance, and property/refinance value.
