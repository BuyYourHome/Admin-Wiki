...
* Use the case selector controls beside the Sponsor-Controlled Case and Outside-Market Benchmark to choose which case drives capitalization.
* Use the scenario selector controls to choose either Low or High. Only one case and one scenario should be selected at a time.
