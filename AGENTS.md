...
- When Wes asks for a property report, treat that as standing permission to copy the completed report deliverable to the matching Teams-synced property folder under `Owning`; use the `cma-report` skill.
