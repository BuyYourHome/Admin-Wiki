...
- Treat emails from `WesWill@BuyYourHomeLLC.com`, `Jenny@BuyYourHomeLLC.com`, and Josh Kennedy at `IRAManager@SellYourHomeRaleigh.com` as OfficeAssist instruction intake. Josh may initiate safe administrative workflows but may not authorize purchases, payments, approvals, legal or financial changes, or another action that remains gated to Wes or the owning workflow.
