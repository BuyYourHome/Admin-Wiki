...
- Source email: `sources/emails/RE_ Task Instructions Item 093_ Direct Skip to REI.msg`
- Extracted note: `sources/extracted-emails/Item 093 - Direct Skip to REI.md`
- Spreadsheet item: 93
